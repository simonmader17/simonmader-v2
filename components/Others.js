                ...
                <Other
                    ...
                    content={
                        <ul className={"ml-4 list-disc"}>
                            <li>
                                Platz 4 von 93 beim 32<sup>nd</sup> School
                                Coding Contest im November 2019 in Wien
                            </li>
                            <li>
                                Platz 12 von 149 beim 32<sup>nd</sup> Classic
                                Coding Contest im November 2019 in Wien
                            </li>
                            <li>
                                Platz 15 von 121 beim 30<sup>th</sup> School
                                Coding Contest im März 2019 in Wien
                            </li>
                            <li>
                                Platz 21 von 149 beim 30<sup>th</sup> Classic
                                Coding Contest im März 2019 in Wien
                            </li>
                        </ul>
                    }
