            ...
            <div className="grid grid-cols-1">
                <Job
                    ...
                    info={
                        <ul className={"ml-4 list-disc"}>
                            ...
                            <li className={"text-gray-400"}>
                                Einrichten einer PHP-Testumgebung mithilfe von
                                Docker (
                                <a
                                    className={"my-link"}
                            ...
                            <li className={"text-gray-400"}>
                                Aufsetzen von PC&apos;s für Kunden (Hardware und
                                Software)
                            </li>
                ...
                <Job
                    ...
                    info={
                        <ul className={"ml-4 list-disc"}>
                            <li className={"text-gray-400"}>
                                Mitarbeit an der Umstellung der PC&apos;s der
                                Mitarbeiter auf Windows 10
                            </li>
                            <li className={"text-gray-400"}>
                                Einführung in die{" "}
                                <a
                ...
                <Job
                    ...
                    info={
                        <ul className={"ml-4 list-disc"}>
                            <li className={"text-gray-400"}>
                                Mitarbeit in der Gemeinde: Rasenmähen, Sträucher
                                schneiden, usw.
                            </li>
                        </ul>
                    }
