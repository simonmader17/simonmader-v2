...
- **CachedSize-Threadpool**
  ...
  Dieser Pool erzeugt dynamisch neue Threads, falls erforderlich. Threads, die länger als 60 Sekunden on Idle (untätig) sind, werden wieder aus dem Threadpool entfernt. Erzeugermethode:
