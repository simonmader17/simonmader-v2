...
const Qualification = ({
  ...
  return (
    <div
      className={`relative m-4 flex max-w-full items-center gap-4 p-6 ${className}`}
    >
...
const Others = ({ qualifications }: OthersInterface) => {
  ...
  return (
    <div className="relative m-4 flex max-w-full flex-wrap items-center justify-around gap-8 p-10 xl:gap-14">
      {items}
      <div className="clip-rounded-pixel absolute inset-0 -z-10 bg-secondary bg-opacity-50" />
    </div>
  );
