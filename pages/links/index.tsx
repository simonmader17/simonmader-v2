        ...
        <div className="flex min-h-screen flex-col items-center justify-center py-8">
          ...
          <div className="mx-auto w-full max-w-[640px]">
            <Link href="/" passHref>
              ...
              >
                <span className="icon-brave-white group-hover:text-brave text-5xl transition-all"></span>
            ...
            <a
              ...
              onPointerDown={(e) => createRipple(e)}
            >
              <span className="icon-gmail-white group-hover:text-gmail text-5xl transition-all"></span>
            ...
            <a
              ...
              onPointerDown={(e) => createRipple(e)}
            >
              <span className="icon-linkedin-white group-hover:text-linkedin text-5xl transition-all"></span>
            ...
            <a
              ...
              onPointerDown={(e) => createRipple(e)}
            >
              <span className="icon-github-white group-hover:text-github text-5xl transition-all"></span>
